...
```shell
npm i github:your_github_username/my-plugin
# or if you use bitbucket
npm i bitbucket:your_github_username/my-plugin
# or if you use gitlab
npm i gitlab:your_github_username/my-plugin
# or plain url
npm i https:/github.com/your_github_username/my-plugin.git
```

Then load the plugin in app's `main.ts` like this.
```js
aurelia.use.plugin('my-plugin');
